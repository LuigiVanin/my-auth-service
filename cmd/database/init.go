...
var (
	...
	managerPermissions = json.RawMessage(`{"api": {"/core/apps": {"query": {"name": "^.+$", "skip": "^[0-9]+$", "limit": "^[0-9]+$"}, "methods": ["POST", "GET"]}, "/core/apps/:id": {"methods": ["GET", "PUT", "DELETE"]}, "/core/apps/:id/users": {"query": {"name": "^.+$", "skip": "^[0-9]+$", "email": "^.+$", "limit": "^[0-9]+$"}, "methods": ["GET", "POST"]}, "/core/users_pool": {"methods": ["GET", "POST", "PUT"]}, "/core/organizations": {"query": {"skip": "^[0-9]+$", "limit": "^[0-9]+$"}, "methods": ["GET", "POST"]}, "/core/organizations/switch": {"methods": ["PUT"]}, "/core/organizations/:id/participants": {"query": {"skip": "^[0-9]+$", "limit": "^[0-9]+$"}, "methods": ["GET"]}}}`)
